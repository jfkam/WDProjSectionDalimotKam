...
### Mental Health Quiz: This feature allows users to answer a multiple choice form that collects mental health related data from the user such as stress level, energy level, source of stress, hours of sleep, coping mechanisms.  Once they click the "Done" button at the bottom of the screen, they will be transported to the next webpage–"Results".
...
*****
## Details
### In our three new proposed webpages, we will use HTML forms for many different functions and roles in each one.  For the first webpage called Mental Health Quiz, we will use HTML form through a multiple choice quiz.  The multiple choice quiz will use radio buttons to represent the choices for each question in the test.  The data collected from the user's answers in the HTML form will be saved in the broswer's localStorage using JavaScript.  We will represent the data we collected from the HTML forms in the other two new webpages using comprehensible diagrams and straightforward suggestions.  In our second webpage named Results, the data from the HTML form; in this case; the user's anxiety and depression levels are represented through a horizontal status bar and drop down text created using HTML.  In our third webpage entitled Next Steps, the data from the HTML form will be used to generate  personalized observations, suggestions and comments to assist the user in taking the next step to improve their mental health.  These recommendations will be represented using drop down text boxes.  CSS animations and Javascript's localStorage will be applied in all three of these webpages to further advance the user's experience using the website and will immerse him or her in the journey in cultivating their emotional health.
*****
## Definition of Done
### The website project will be considered finished when a set of objectives that me and my partner have created are all achieved.  Firstly, the three webpages are connected to each other using hyperlinks in the form of buttons that are found at the bottom of a screen.  The first webpage is considered finished when it's a fully functional HTML quiz that collects data using the HTML elements and uses JavaScript to save this data in the localStorage.  The second webpage is considered complete when it successfully gathers the data from the first webpage's quiz and creates a status bar that represents the anxiety and depression level of a person based on the computed data from the quiz.  The third webpage is considered complete when the data from the first webpage flows perfectly to this one and this data is used to create personalized statements about the user's mental health and how they can take the next steps in improving their emotional health.  
### A settings or control center button will also be placed at the upper right area of the website with the options of inputting and changing your username, password and email as well as logging out or switching your account.  Our website must also be capable of working on both phones and laptops to allow the user easier access to the website which would in turn, assist them in improving their psychological–the main purpose of the creation of this website.
*****
## Wireframe
### Laptop version

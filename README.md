...
### Settings: This feature is the control sector of the entire website. It contains the user's profile including username, password, and email(optional). Aside from that, there will be different modes that the user can alternate between--- the light and dark mode.
